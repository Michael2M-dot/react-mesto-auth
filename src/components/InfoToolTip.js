	...
	return(
		...
		>
			<div className="popup__window popup__window_size_s">
				<div className={`popup__icon ${isSignedUp ? "popup__icon_status_succeed" : "popup__icon_status_fault"}`}/>
				<h2 className="popup__title popup__title_pos_centered">{authUser.message}</h2>
				<button
